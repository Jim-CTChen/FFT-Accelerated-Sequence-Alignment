import numpy as np
import random
from config import DNA_4, RNA_4, AMINO_ACID_20, POLARITY_MAPPING, VOLUME_MAPPING, AMINO_ACID_MAPPING
...
def random_gen_seq(len=None, limit = 512, data_type='DNA') -> np.ndarray:
    '''
        if !len: length range from [128, limit]
        else: length = len
